...
- [BugShot](https://github.com/SinhyeokKang/bugshot-2). Open-source Chrome extension that builds a reproducible bug report from the browser — annotated screenshots or recordings, plus automatically captured console, network and user-action logs — and files it to Jira, GitHub, Linear, Notion, GitLab, Asana, ClickUp or Slack. Capture data never passes through a vendor server.
